...
//SQL文の実行
    $strSQL = "insert into chat3_tbl(chat_id,chat_kaiwa,item_date)";
...
//SQL文の作成
$strSQL_1="select * from chat3_tbl";
...
?>
        <hr>
        <form id="toukou" method="post" action="hew_3.php">
    <p>ID</p>
